...
//   const [userCardsData, setBankCardsData] = React.useState([])
//   const [selectedBankName, setSelectedBankName] = React.useState({})
//   const [usersCardData, setBanksCardData] = React.useState({
//     name: '',
//     category: ''
//   })
//   const [usersCardTableData, setBanksCardTableData] = React.useState([])
//   const navigate = useNavigate();

//   const fetchDataById = async () => {
//     // get data from firestore
//     try {
//       const getSpecificDoc = await getDoc(doc(db, "users", id));
...
//     const updateData = {
//       cards: arrayUnion(...usersCardTableData.map((items) => {
//         return {
//           name: items.name,
//           category: items.category,
//           image: usersCardData.image,
//         }
//       }))
//     }
...
//   const onAddCards = () => {
//     setBanksCardTableData([...usersCardTableData, {
//       name: usersCardData.name,
//       category: usersCardData.category
//     }])
//     setBanksCardData({
//       name: '',
//       category: ''
